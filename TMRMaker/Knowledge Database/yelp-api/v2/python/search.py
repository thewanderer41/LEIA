...
parser.add_option('-c', '--consumer_key', dest='consumer_key', help='OAuth consumer key (REQUIRED)', default='-BEVFQVZmk5rZcKaiZGing')
parser.add_option('-s', '--consumer_secret', dest='consumer_secret', help='OAuth consumer secret (REQUIRED)', default='QCbHLVo1iEE89OeDr4Or5mmvzsU')
parser.add_option('-t', '--token', dest='token', help='OAuth token (REQUIRED)', default='Xi0W1EX2VlOfyc7Cy3nmxoG-gaewffeX')
parser.add_option('-e', '--token_secret', dest='token_secret', help='OAuth token secret (REQUIRED)', default='_BSPh78wNtYNDEqfiUNqNQlSxZo')
